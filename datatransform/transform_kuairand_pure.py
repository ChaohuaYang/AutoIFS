...
class DataTransform(object):
    ...
    def _read(self, name=None, header=None, sep=None, label_index="", domain_id=""):
        ...
        domain_0_data = self.data[self.data['domain_id'] == 0]
        domain_1_data = self.data[self.data['domain_id'] == 1]
        domain_2_data = self.data[self.data['domain_id'] == 2]
        print(domain_0_data.shape[0], domain_0_data[domain_0_data[label_index[0]] == 1].shape[0], domain_0_data[domain_0_data[label_index[1]] == 1].shape[0])
        print(domain_1_data.shape[0], domain_1_data[domain_1_data[label_index[0]] == 1].shape[0], domain_1_data[domain_1_data[label_index[1]] == 1].shape[0])
        print(domain_2_data.shape[0], domain_2_data[domain_2_data[label_index[0]] == 1].shape[0], domain_2_data[domain_2_data[label_index[1]] == 1].shape[0])
